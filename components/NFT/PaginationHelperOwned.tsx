...
const PaginationHelperProfile: FC<IProps> = ({ setPage, contractAddress, totalItems, itemsPerPage }) => {
  ...
  const validTotalSupply = totalItems; // Use the totalItems prop for pagination calculation
  
  const noOfPages = useMemo(() => Math.ceil(validTotalSupply / itemsPerPage), [validTotalSupply, itemsPerPage]);
