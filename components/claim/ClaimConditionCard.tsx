...
import { getActiveClaimCondition, nextTokenIdToMint, setClaimConditions } from "thirdweb/extensions/erc1155";
...
export const ClaimCard: FC<INFTCardProps> = ({ tokenId, contractAddress, chainId }) => {
